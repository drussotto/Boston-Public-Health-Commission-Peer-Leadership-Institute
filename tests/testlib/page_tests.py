...
assert_404_page, assert_not_404_page = check_page(["Page Not Found"], "404")
assert_403_page, assert_not_403_page = check_page(["Not Authorized"], "403")
...
assert_response_submitted_page, assert_response_failed_page = check_page(["Thank you"], "submit_response")
